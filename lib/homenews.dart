    ...
    return new Scaffold(
      ...
      body: ListView(
        scrollDirection: Axis.vertical,
         children: <Widget>[
                 Container(
                  child: _childList('assets/pic/child.png'),
                ),
           SizedBox(height: 10.0,),
              Container(
             padding: EdgeInsets.only(top: 10.0,left: 20.0,right: 15.0),
             child: Text('اصدار شهادة تحمل ضريبة القيمة المضافة',textDirection: TextDirection.rtl,
           ...
           SizedBox(height: 1.0,),
                 Container(
                   ...
                   child: Text('مبادرة تحمل ضريبة القيمه المضافة للمسكن الاول لتقليل كلفة امتلاك المسكن المناسب على المواطنين, ستحمل وزارة الاسكان سداد ضريبة القيمة المضافة للمسكن الاول',textDirection: TextDirection.rtl,
                     style: TextStyle(
                         fontSize: 20.0,
                         color: Colors.grey,
                   ),
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            ...
            InkWell(child: Container(
              child: Image.asset('assets/pic/child.png',
                width: MediaQuery
                    .of(context)
                    .size
                    .width,
